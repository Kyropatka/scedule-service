package com.gmail.deniska1406sme.sceduleservice.model;
...
public class Event {
    ...
    public Event(Long id, Long userId, String title, String description, ZonedDateTime startTime, ZonedDateTime endTime, Integer notificationOffsetMinutes) {
        this.id = id;
        this.userId = userId;
        this.title = title;
